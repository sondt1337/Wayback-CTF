...
- [CTF Scoreboard System](#ctf-scoreboard-system-1)
  ...
  - [Running the Application](#running-the-application-1)
    - [1. Run Flask Application Locally (Without Docker)](#1-run-flask-application-locally-without-docker-1)
    - [Dockerfile Breakdown](#dockerfile-breakdown-1)
  - [Kubernetes Deployment](#kubernetes-deployment-1)
    - [1. Apply Kubernetes Configurations](#1-apply-kubernetes-configurations-1)
    - [Kubernetes Files Overview](#kubernetes-files-overview-1)
  - [Accessing the Application](#accessing-the-application-1)
  - [Monitoring and Scaling](#monitoring-and-scaling-1)
    - [View Logs](#view-logs-1)
    - [Scaling with Horizontal Pod Autoscaler](#scaling-with-horizontal-pod-autoscaler-1)
    - [Manually Scaling Pods](#manually-scaling-pods-1)
